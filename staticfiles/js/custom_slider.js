$(function () {
  $(".numeric-slider-range").slider({
    ...
    slide: function (event, ui) {
      ...
      $("#" + $(this).parent().attr("id") + "_text").text(
    ...
    create: function (event, ui) {
      ...
      $(this).slider("option", "values", [
        $(this).parent().data("cur_min"),
        $(this).parent().data("cur_max"),
      ]);
    },
  });
  $("#" + $(".numeric-slider").attr("id") + "_min").val(
    $(".numeric-slider").data("cur_min")
  );
  $("#" + $(".numeric-slider").attr("id") + "_max").val(
    $(".numeric-slider").data("cur_max")
  );
  $("#" + $(".numeric-slider").attr("id") + "_text").text(
    ui.values[0] + " - " + ui.values[1]
  );
});
